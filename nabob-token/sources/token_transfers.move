...
module nabob_token::token_transfers {
    use std::signer;
    use std::string::String;
    use std::error;
    use nabob_std::table::{Self, Table};
    use nabob_token::token::{Self, Token, TokenId};
    ...
    public fun test_nft(creator: signer, owner: signer) acquires PendingClaims {
        ...
        nabob_framework::account::create_account_for_test(owner_addr);
    ...
    public fun test_editions(
        ...
        nabob_framework::account::create_account_for_test(owner0_addr);
        let owner1_addr = signer::address_of(&owner1);
        nabob_framework::account::create_account_for_test(owner1_addr);
    ...
    public fun create_token(creator: &signer, amount: u64): TokenId {
        ...
        nabob_framework::account::create_account_for_test(signer::address_of(creator));
