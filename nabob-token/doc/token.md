...
<dl>
<dt>
<code>tokens: <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<a href="token.md#0x3_token_TokenId">token::TokenId</a>, <a href="token.md#0x3_token_Token">token::Token</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>deposit_events: <a href="../../nabob-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_DepositEvent">token::DepositEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>withdraw_events: <a href="../../nabob-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_WithdrawEvent">token::WithdrawEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>burn_events: <a href="../../nabob-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_BurnTokenEvent">token::BurnTokenEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>mutate_token_property_events: <a href="../../nabob-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_MutateTokenPropertyMapEvent">token::MutateTokenPropertyMapEvent</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>token_data: <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<a href="token.md#0x3_token_TokenDataId">token::TokenDataId</a>, <a href="token.md#0x3_token_TokenData">token::TokenData</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>create_collection_events: <a href="../../nabob-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_CreateCollectionEvent">token::CreateCollectionEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>create_token_data_events: <a href="../../nabob-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_CreateTokenDataEvent">token::CreateTokenDataEvent</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>mint_token_events: <a href="../../nabob-framework/doc/event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="token.md#0x3_token_MintTokenEvent">token::MintTokenEvent</a>&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code><a href="../../nabob-framework/doc/account.md#0x1_account">account</a>: <b>address</b></code>
</dt>
<dd>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="token.md#0x3_token_mutate_token_properties">mutate_token_properties</a>(
    ...
    <b>while</b> (i &lt; amount) {
        <a href="token.md#0x3_token_mutate_one_token">mutate_one_token</a>(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>, token_owner, token_id, keys, values, types);
        i = i + 1;
    };
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="token.md#0x3_token_opt_in_direct_transfer">opt_in_direct_transfer</a>(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, opt_in: bool) <b>acquires</b> <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    ...
    *opt_in_flag = opt_in;
    <a href="token_event_store.md#0x3_token_event_store_emit_token_opt_in_event">token_event_store::emit_token_opt_in_event</a>(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>, opt_in);
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="token.md#0x3_token_burn_by_creator">burn_by_creator</a>(
    ...
    <b>if</b> (std::features::module_event_migration_enabled()) {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit">event::emit</a>(<a href="token.md#0x3_token_Burn">Burn</a> { <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>: owner, id: token_id, amount: burned_amount });
    } <b>else</b> {
    ...
    <b>if</b> (token_data.maximum &gt; 0) {
        ...
        <b>if</b> (token_data.supply == 0) {
            <a href="token.md#0x3_token_destroy_token_data">destroy_token_data</a>(<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_remove">table::remove</a>(&<b>mut</b> collections.token_data, token_id.token_data_id));

            // <b>update</b> the collection supply
            <b>let</b> collection_data = <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(
            ...
            <b>if</b> (collection_data.maximum &gt; 0) {
                ...
                <b>if</b> (collection_data.supply == 0) {
                    <a href="token.md#0x3_token_destroy_collection_data">destroy_collection_data</a>(<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_remove">table::remove</a>(&<b>mut</b> collections.collection_data, collection_data.name));
                };
            };
        };
    };
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_mutate_one_token">mutate_one_token</a>(
    ...
    <b>if</b> (token_id.property_version == 0) {
        ...
        <b>if</b> (std::features::module_event_migration_enabled()) {
            <a href="../../nabob-framework/doc/event.md#0x1_event_emit">event::emit</a>(<a href="token.md#0x3_token_MutatePropertyMap">MutatePropertyMap</a> {
                <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>: token_owner,
                old_id: token_id,
                new_id: new_token_id,
                keys,
                values,
            ...
            <a href="../../nabob-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_MutateTokenPropertyMapEvent">MutateTokenPropertyMapEvent</a>&gt;(
    ...
    <b>if</b> (!<b>exists</b>&lt;<a href="token.md#0x3_token_TokenStore">TokenStore</a>&gt;(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>))) {
        <b>move_to</b>(
            ...
            <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
                tokens: <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_new">table::new</a>(),
                direct_transfer: <b>false</b>,
                deposit_events: <a href="../../nabob-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_DepositEvent">DepositEvent</a>&gt;(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>),
                withdraw_events: <a href="../../nabob-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_WithdrawEvent">WithdrawEvent</a>&gt;(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>),
                burn_events: <a href="../../nabob-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_BurnTokenEvent">BurnTokenEvent</a>&gt;(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>),
                mutate_token_property_events: <a href="../../nabob-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_MutateTokenPropertyMapEvent">MutateTokenPropertyMapEvent</a>&gt;(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>),
            },
        );
    }
}
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_create_collection">create_collection</a>(
    ...
    <b>if</b> (!<b>exists</b>&lt;<a href="token.md#0x3_token_Collections">Collections</a>&gt;(account_addr)) {
        <b>move_to</b>(
            ...
            <a href="token.md#0x3_token_Collections">Collections</a> {
                collection_data: <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_new">table::new</a>(),
                token_data: <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_new">table::new</a>(),
                create_collection_events: <a href="../../nabob-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_CreateCollectionEvent">CreateCollectionEvent</a>&gt;(creator),
                create_token_data_events: <a href="../../nabob-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_CreateTokenDataEvent">CreateTokenDataEvent</a>&gt;(creator),
                mint_token_events: <a href="../../nabob-framework/doc/account.md#0x1_account_new_event_handle">account::new_event_handle</a>&lt;<a href="token.md#0x3_token_MintTokenEvent">MintTokenEvent</a>&gt;(creator),
            },
        )
    };
    ...
    <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_add">table::add</a>(collection_data, name, collection);
    ...
    <b>if</b> (std::features::module_event_migration_enabled()) {
        ...
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_CreateCollectionEvent">CreateCollectionEvent</a>&gt;(
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_check_tokendata_exists">check_tokendata_exists</a>(creator: <b>address</b>, collection_name: String, token_name: String): bool <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a> {
    ...
    <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(token_data, token_data_id)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_create_tokendata">create_tokendata</a>(
    ...
    <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_add">table::add</a>(&<b>mut</b> collections.token_data, token_data_id, token_data);
    <b>if</b> (std::features::module_event_migration_enabled()) {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit">event::emit</a>(
        ...
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_CreateTokenDataEvent">CreateTokenDataEvent</a>&gt;(
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_mint_token">mint_token</a>(
    ...
    <b>if</b> (std::features::module_event_migration_enabled()) {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit">event::emit</a>(<a href="token.md#0x3_token_Mint">Mint</a> { creator: creator_addr, id: token_data_id, amount })
    } <b>else</b> {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_MintTokenEvent">MintTokenEvent</a>&gt;(
    ...
    <a href="token.md#0x3_token_deposit_token">deposit_token</a>(<a href="../../nabob-framework/doc/account.md#0x1_account">account</a>,
        <a href="token.md#0x3_token_Token">Token</a> {
            id: token_id,
            amount,
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_balance_of">balance_of</a>(owner: <b>address</b>, id: <a href="token.md#0x3_token_TokenId">TokenId</a>): u64 <b>acquires</b> <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    ...
    <b>if</b> (<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&token_store.tokens, id)) {
        <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(&token_store.tokens, id).amount
    } <b>else</b> {
        0
    }
}
...
<pre><code><b>public</b> <b>fun</b> <a href="token.md#0x3_token_get_property_map">get_property_map</a>(owner: <b>address</b>, token_id: <a href="token.md#0x3_token_TokenId">TokenId</a>): PropertyMap <b>acquires</b> <a href="token.md#0x3_token_Collections">Collections</a>, <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    ...
    <b>if</b> (token_id.property_version == 0) {
        ...
        <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_borrow">table::borrow</a>(tokens, token_id).token_properties
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="token.md#0x3_token_withdraw_with_event_internal">withdraw_with_event_internal</a>(
    ...
    <b>if</b> (std::features::module_event_migration_enabled()) {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit">event::emit</a>(<a href="token.md#0x3_token_TokenWithdraw">TokenWithdraw</a> { <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>: account_addr, id, amount })
    } <b>else</b> {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_WithdrawEvent">WithdrawEvent</a>&gt;(
    ...
    <b>if</b> (*balance &gt; amount) {
        *balance = *balance - amount;
        ...
        <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_remove">table::remove</a>(tokens, id)
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="token.md#0x3_token_direct_deposit">direct_deposit</a>(account_addr: <b>address</b>, <a href="token.md#0x3_token">token</a>: <a href="token.md#0x3_token_Token">Token</a>) <b>acquires</b> <a href="token.md#0x3_token_TokenStore">TokenStore</a> {
    ...
    <b>if</b> (std::features::module_event_migration_enabled()) {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit">event::emit</a>(<a href="token.md#0x3_token_TokenDeposit">TokenDeposit</a> { <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>: account_addr, id: <a href="token.md#0x3_token">token</a>.id, amount: <a href="token.md#0x3_token">token</a>.amount });
    } <b>else</b> {
        <a href="../../nabob-framework/doc/event.md#0x1_event_emit_event">event::emit_event</a>&lt;<a href="token.md#0x3_token_DepositEvent">DepositEvent</a>&gt;(
    ...
    <b>if</b> (!<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_contains">table::contains</a>(&token_store.tokens, <a href="token.md#0x3_token">token</a>.id)) {
        <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_add">table::add</a>(&<b>mut</b> token_store.tokens, <a href="token.md#0x3_token">token</a>.id, <a href="token.md#0x3_token">token</a>);
    } <b>else</b> {
        <b>let</b> recipient_token = <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_borrow_mut">table::borrow_mut</a>(&<b>mut</b> token_store.tokens, <a href="token.md#0x3_token">token</a>.id);
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="token_event_store.md#0x3_token_event_store_TokenEventStoreV1">token_event_store::TokenEventStoreV1</a>&gt;(addr) && account_addr.guid_creation_num + 9 &gt; <a href="../../nabob-framework/doc/account.md#0x1_account_MAX_GUID_CREATION_NUM">account::MAX_GUID_CREATION_NUM</a>;
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="token_event_store.md#0x3_token_event_store_TokenEventStoreV1">token_event_store::TokenEventStoreV1</a>&gt;(addr) && !<b>exists</b>&lt;<a href="../../nabob-framework/doc/account.md#0x1_account_Account">account::Account</a>&gt;(addr);
</code></pre>
...
<b>let</b> creator_addr = token_id.token_data_id.creator;
<b>let</b> collections = <b>borrow_global_mut</b>&lt;<a href="token.md#0x3_token_Collections">Collections</a>&gt;(creator_address);
<b>let</b> token_data = <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_get">table::spec_get</a>(
...
<b>aborts_if</b> !<a href="../../nabob-framework/../nabob-stdlib/doc/simple_map.md#0x1_simple_map_spec_contains_key">simple_map::spec_contains_key</a>(token_data.default_properties.map, std::string::spec_utf8(<a href="token.md#0x3_token_BURNABLE_BY_CREATOR">BURNABLE_BY_CREATOR</a>));
</code></pre>
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="token_event_store.md#0x3_token_event_store_TokenEventStoreV1">token_event_store::TokenEventStoreV1</a>&gt;(addr) && !<b>exists</b>&lt;<a href="../../nabob-framework/doc/account.md#0x1_account_Account">account::Account</a>&gt;(addr);
<b>aborts_if</b> !<b>exists</b>&lt;<a href="token_event_store.md#0x3_token_event_store_TokenEventStoreV1">token_event_store::TokenEventStoreV1</a>&gt;(addr) && <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>.guid_creation_num + 9 &gt;= <a href="../../nabob-framework/doc/account.md#0x1_account_MAX_GUID_CREATION_NUM">account::MAX_GUID_CREATION_NUM</a>;
<b>aborts_if</b> !<b>exists</b>&lt;<a href="token_event_store.md#0x3_token_event_store_TokenEventStoreV1">token_event_store::TokenEventStoreV1</a>&gt;(addr) && <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>.guid_creation_num + 9 &gt; MAX_U64;
</code></pre>
...
<b>aborts_if</b> !<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(all_token_data, token_id.token_data_id);
<b>aborts_if</b> !token_data.mutability_config.properties && !<a href="../../nabob-framework/../nabob-stdlib/doc/simple_map.md#0x1_simple_map_spec_contains_key">simple_map::spec_contains_key</a>(token_data.default_properties.map, std::string::spec_utf8(<a href="token.md#0x3_token_TOKEN_PROPERTY_MUTABLE">TOKEN_PROPERTY_MUTABLE</a>));
</code></pre>
...
<pre><code><b>schema</b> <a href="token.md#0x3_token_CreateRoyaltyAbortsIf">CreateRoyaltyAbortsIf</a> {
    ...
    <b>aborts_if</b> !<b>exists</b>&lt;<a href="../../nabob-framework/doc/account.md#0x1_account_Account">account::Account</a>&gt;(payee_address);
}
</code></pre>
...
<pre><code><b>let</b> now_seconds = <b>global</b>&lt;<a href="../../nabob-framework/doc/timestamp.md#0x1_timestamp_CurrentTimeMicroseconds">timestamp::CurrentTimeMicroseconds</a>&gt;(@nabob_framework).microseconds;
<b>aborts_if</b> !<b>exists</b>&lt;<a href="../../nabob-framework/doc/timestamp.md#0x1_timestamp_CurrentTimeMicroseconds">timestamp::CurrentTimeMicroseconds</a>&gt;(@nabob_framework);
<b>aborts_if</b> now_seconds / <a href="../../nabob-framework/doc/timestamp.md#0x1_timestamp_MICRO_CONVERSION_FACTOR">timestamp::MICRO_CONVERSION_FACTOR</a> &gt; withdraw_proof.expiration_sec;
<b>include</b> <a href="token.md#0x3_token_WithdrawWithEventInternalAbortsIf">WithdrawWithEventInternalAbortsIf</a>{
...
<pre><code><b>schema</b> <a href="token.md#0x3_token_CreateCollectionAbortsIf">CreateCollectionAbortsIf</a> {
    ...
    <b>aborts_if</b> b && !<b>exists</b>&lt;<a href="../../nabob-framework/doc/account.md#0x1_account_Account">account::Account</a>&gt;(addr);
    <b>aborts_if</b> len(name.bytes) &gt; <a href="token.md#0x3_token_MAX_COLLECTION_NAME_LENGTH">MAX_COLLECTION_NAME_LENGTH</a>;
    <b>aborts_if</b> len(uri.bytes) &gt; <a href="token.md#0x3_token_MAX_URI_LENGTH">MAX_URI_LENGTH</a>;
    <b>aborts_if</b> b && <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>.guid_creation_num + 3 &gt;= <a href="../../nabob-framework/doc/account.md#0x1_account_MAX_GUID_CREATION_NUM">account::MAX_GUID_CREATION_NUM</a>;
    <b>aborts_if</b> b && <a href="../../nabob-framework/doc/account.md#0x1_account">account</a>.guid_creation_num + 3 &gt; MAX_U64;
...
<b>aborts_if</b> !<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(collections.collection_data, collection);
<b>aborts_if</b> <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(collections.token_data, token_data_id);
...
<b>aborts_if</b> !<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(all_token_data, token_data_id);
</code></pre>
...
<pre><code><b>fun</b> <a href="token.md#0x3_token_spec_balance_of">spec_balance_of</a>(owner: <b>address</b>, id: <a href="token.md#0x3_token_TokenId">TokenId</a>): u64 {
   ...
   <b>else</b> <b>if</b> (<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(token_store.tokens, id)) {
       <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_get">table::spec_get</a>(token_store.tokens, id).amount
   } <b>else</b> {
       0
   }
}
...
<b>aborts_if</b> token_id.property_version == 0 && !<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(all_token_data, token_id.token_data_id);
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="token.md#0x3_token_Collections">Collections</a>&gt;(creator);
<b>aborts_if</b> !<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(all_collection_data, collection_name);
</code></pre>
...
<pre><code><b>schema</b> <a href="token.md#0x3_token_WithdrawWithEventInternalAbortsIf">WithdrawWithEventInternalAbortsIf</a> {
    ...
    <b>aborts_if</b> !<b>exists</b>&lt;<a href="token.md#0x3_token_TokenStore">TokenStore</a>&gt;(account_addr);
    <b>aborts_if</b> !<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(tokens, id);
}
</code></pre>
...
<b>aborts_if</b> !<a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(tokens, token_id);
</code></pre>
...
<pre><code><b>schema</b> <a href="token.md#0x3_token_DirectDepositAbortsIf">DirectDepositAbortsIf</a> {
    ...
    <b>let</b> recipient_token = <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_get">table::spec_get</a>(token_store.tokens, token_id);
    <b>let</b> b = <a href="../../nabob-framework/../nabob-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(token_store.tokens, token_id);
