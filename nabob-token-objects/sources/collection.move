...
module nabob_token_objects::collection {
    use std::error;
    use std::features;
    use std::option::{Self, Option};
    use std::signer;
    use std::string::{Self, String};
    use nabob_framework::aggregator_v2::{Self, Aggregator, AggregatorSnapshot};
    use nabob_framework::event;
    use nabob_framework::object::{Self, ConstructorRef, ExtendRef, Object};

    use nabob_token_objects::royalty::{Self, Royalty};
    #[test_only]
    use std::vector;

    friend nabob_token_objects::token;
    ...
    entry fun test_create_and_transfer_as_owner(creator: &signer, trader: &signer, nabob_framework: &signer) {
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = nabob_token_objects::collection)]
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20009, location = nabob_token_objects::collection)]
