/// `PropertyMap` provides generic metadata support for `NabobToken`. It is a specialization of
...
module nabob_token_objects::property_map {
    use std::bcs;
    use std::vector;
    use std::error;
    ...
    use nabob_framework::object::{Self, ConstructorRef, Object, ExtendRef, ObjectCore};
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = nabob_std::from_bcs)]
