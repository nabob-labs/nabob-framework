...
module nabob_framework::chain_status {
    ...
    public(friend) fun set_genesis_end(nabob_framework: &signer) {
        system_addresses::assert_nabob_framework(nabob_framework);
        move_to(nabob_framework, GenesisEndMarker {});
    }

    #[view]
    /// Helper function to determine if Nabob is in genesis state.
    public fun is_genesis(): bool {
        !exists<GenesisEndMarker>(@nabob_framework)
    }
