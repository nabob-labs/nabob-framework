spec nabob_framework::code {
    ...
    /// Enforcement: The Nabob upgrade native functions have been manually audited.
    ///
    /// No.: 2
    ...
    spec initialize(nabob_framework: &signer, package_owner: &signer, metadata: PackageMetadata) {
