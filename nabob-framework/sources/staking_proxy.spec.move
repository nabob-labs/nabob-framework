spec nabob_framework::staking_proxy {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: Enforced via [https://github.com/nabob-labs/nabob-core/blob/main/nabob-move/framework/nabob-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
    ...
    spec schema SetStakingContractOperator {
        ...
        use nabob_framework::staking_contract::{Store};
