...
module nabob_framework::coin {
    ...
    use nabob_std::type_info::{Self, TypeInfo, type_name};
    ...
    /// Create APT pairing by passing `NabobCoin`.
    ...
    inline fun create_and_return_paired_metadata_if_not_exist<CoinType>(allow_bob_creation: bool): Object<Metadata> {
        ...
        if (!table::contains(&map.coin_to_fungible_asset_map, type)) {
            ...
            assert!(!is_apt || allow_bob_creation, error::invalid_state(EBOB_PAIRING_IS_NOT_ENABLED));
    ...
    #[test(account = @nabob_framework, aaron = @0xaa10)]
