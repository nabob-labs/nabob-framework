...
module nabob_framework::optional_aggregator {
    use std::error;
    use std::option::{Self, Option};

    use nabob_framework::aggregator_factory;
    use nabob_framework::aggregator::{Self, Aggregator};
    ...
    #[test(account = @nabob_framework)]
    #[expected_failure(abort_code = 0x020001, location = nabob_framework::aggregator)]
    ...
    #[test(account = @nabob_framework)]
    #[expected_failure(abort_code = 0x020002, location = nabob_framework::aggregator)]
