...
module nabob_framework::staking_config {
    use std::error;
    use std::features;
    ...
    use nabob_std::fixed_point64::{Self, FixedPoint64, less_or_equal};
    use nabob_std::math_fixed64;

    friend nabob_framework::genesis;
    friend nabob_framework::stake;
    ...
    public(friend) fun initialize(
        ...
        move_to(nabob_framework, StakingConfig {
            minimum_stake,
            maximum_stake,
    ...
    public fun reward_rate(): (u64, u64) acquires StakingRewardsConfig, StakingConfig {
        get_reward_rate(borrow_global<StakingConfig>(@nabob_framework))
    }
    ...
    public fun initialize_rewards(
        ...
        move_to(nabob_framework, StakingRewardsConfig {
            rewards_rate,
            min_rewards_rate,
            rewards_rate_period_in_secs,
    ...
    public fun get(): StakingConfig acquires StakingConfig {
        *borrow_global<StakingConfig>(@nabob_framework)
    }
    ...
    public fun get_reward_rate(config: &StakingConfig): (u64, u64) acquires StakingRewardsConfig {
        if (features::periodical_reward_rate_decrease_enabled()) {
            let epoch_rewards_rate = borrow_global<StakingRewardsConfig>(@nabob_framework).rewards_rate;
    ...
    fun calculate_and_save_latest_rewards_config(): StakingRewardsConfig acquires StakingRewardsConfig {
        let staking_rewards_config = borrow_global_mut<StakingRewardsConfig>(@nabob_framework);
    ...
    public fun update_required_stake(
        ...
        let staking_config = borrow_global_mut<StakingConfig>(@nabob_framework);
    ...
    #[test_only]
    use nabob_std::fixed_point64::{equal, create_from_rational};
    ...
    public entry fun test_change_staking_configs(nabob_framework: signer) acquires StakingConfig {
        ...
        update_rewards_rate(&nabob_framework, 10, 100);
        update_voting_power_increase_limit(&nabob_framework, 10);

        let config = borrow_global<StakingConfig>(@nabob_framework);
    ...
    #[test(nabob_framework = @nabob_framework)]
    public entry fun test_staking_rewards_rate_decrease_over_time(nabob_framework: signer) acquires StakingRewardsConfig {
    ...
    #[test(nabob_framework = @nabob_framework)]
    public entry fun test_change_staking_rewards_configs(nabob_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &nabob_framework,
            create_from_rational(1, 100),
        ...
        let config = borrow_global<StakingRewardsConfig>(@nabob_framework);
    ...
    #[test(account = @0x123, nabob_framework = @nabob_framework)]
    #[expected_failure(abort_code = 0x50003, location = nabob_framework::system_addresses)]
    public entry fun test_update_rewards_config_unauthorized_should_fail(account: signer, nabob_framework: signer) acquires StakingRewardsConfig {
    ...
    public entry fun test_update_required_stake_invalid_range_should_fail(nabob_framework: signer) acquires StakingConfig {
        update_required_stake(&nabob_framework, 10, 5);
    }

    #[test(nabob_framework = @nabob_framework)]
    #[expected_failure(abort_code = 0x10003, location = Self)]
    public entry fun test_update_required_stake_zero_max_stake_should_fail(nabob_framework: signer) acquires StakingConfig {
        update_required_stake(&nabob_framework, 0, 0);
    }

    #[test(nabob_framework = @nabob_framework)]
    #[expected_failure(abort_code = 0x10001, location = Self)]
    public entry fun test_update_required_lockup_to_zero_should_fail(nabob_framework: signer) acquires StakingConfig {
        update_recurring_lockup_duration_secs(&nabob_framework, 0);
    }
    ...
    public entry fun test_update_rewards_config_rewards_rate_greater_than_1_should_fail(nabob_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &nabob_framework,
    ...
    public entry fun test_update_rewards_config_invalid_rewards_rate_decrease_rate_should_fail(nabob_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &nabob_framework,
            create_from_rational(15981, 1000000000),
    ...
    public entry fun test_update_rewards_config_cannot_change_rewards_rate_period(nabob_framework: signer) acquires StakingRewardsConfig {
        let start_time_in_secs: u64 = 100001000000;
        initialize_rewards_for_test(
            &nabob_framework,
            create_from_rational(15981, 1000000000),
    ...
    public entry fun test_feature_flag_disabled_get_epoch_rewards_rate_should_fail(nabob_framework: signer) acquires StakingRewardsConfig {
        features::change_feature_flags_for_testing(&nabob_framework, vector[], vector[features::get_periodical_reward_rate_decrease_feature()]);
    ...
    #[test(nabob_framework = @nabob_framework)]
    #[expected_failure(abort_code = 0x10004, location = nabob_framework::staking_config)]
    public entry fun test_update_voting_power_increase_limit_to_more_than_upper_bound_should_fail(
        nabob_framework: signer
    ) acquires StakingConfig {
        update_voting_power_increase_limit(&nabob_framework, 51);
    }
    ...
    public fun initialize_for_test(
        ...
        if (!exists<StakingConfig>(@nabob_framework)) {
            move_to(nabob_framework, StakingConfig {
                minimum_stake,
                maximum_stake,
                recurring_lockup_duration_secs,
