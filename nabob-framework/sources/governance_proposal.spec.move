spec nabob_framework::governance_proposal {
    /// <high-level-req>
    /// No.: 1
    ...
    ///
    /// No.: 2
    /// Requirement: The governance proposal module should only be accessible to the nabob governance.
    /// Criticality: Medium
    /// Implementation: Both create_proposal and create_empty_proposal functions are only available to the friend module
    /// nabob_framework::nabob_governance.
