module nabob_framework::rate_limiter {
    ...
    fun test_initialize_bucket(nabob_framework: &signer) {
    ...
    #[test(nabob_framework = @0x1)]
    fun test_request_success(nabob_framework: &signer) {
        timestamp::set_time_has_started_for_testing(nabob_framework);
    ...
    #[test(nabob_framework = @0x1)]
    fun test_request_failure(nabob_framework: &signer) {
        timestamp::set_time_has_started_for_testing(nabob_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(nabob_framework = @0x1)]
    fun test_refill(nabob_framework: &signer) {
        timestamp::set_time_has_started_for_testing(nabob_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(nabob_framework= @0x1)]
    fun test_fractional_accumulation(nabob_framework: &signer) {
        timestamp::set_time_has_started_for_testing(nabob_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(nabob_framework= @0x1)]
    fun test_multiple_refills(nabob_framework: &signer) {
        timestamp::set_time_has_started_for_testing(nabob_framework);
        let bucket = initialize(10, 60);
