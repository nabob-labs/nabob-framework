module nabob_framework::permissioned_delegation {
    use std::error;
    ...
    use nabob_framework::bcs_stream::{Self, deserialize_u8};
    use nabob_framework::permissioned_signer::{Self, is_permissioned_signer, StorablePermissionedHandle};
    use nabob_framework::rate_limiter;
    use nabob_framework::rate_limiter::RateLimiter;
    #[test_only]
    use std::bcs;
    #[test_only]
    use std::option;
    ...
    #[test_only]
    use nabob_std::ed25519::{sign_arbitrary_bytes, generate_keys, validated_public_key_to_bytes, Signature,
    ...
    fun test_basics(account: signer, account_copy: signer) acquires RegisteredDelegations {
        let nabob_framework = create_signer_for_test(@nabob_framework);
