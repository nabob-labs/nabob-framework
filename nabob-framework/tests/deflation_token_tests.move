...
module 0xcafe::deflation_token_tests {
    ...
    use nabob_framework::function_info;
    use nabob_framework::fungible_asset::{Self, Metadata, TestToken};
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x70002, location = nabob_framework::dispatchable_fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001C, location = nabob_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x8001D, location = nabob_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001A, location = nabob_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001B, location = nabob_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(major_status=1081, location = nabob_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=2, location = nabob_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=0x6001E, location = nabob_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x50008, location = nabob_framework::fungible_asset)]
