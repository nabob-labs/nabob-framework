...
module 0xcafe::deflation_token {
    use nabob_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use nabob_framework::dispatchable_fungible_asset;
    use nabob_framework::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use nabob_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=nabob_framework::dispatchable_fungible_asset)]
