...
<tr>
<td>2</td>
<td>The governance proposal module should only be accessible to the nabob governance.</td>
<td>Medium</td>
<td>Both create_proposal and create_empty_proposal functions are only available to the friend module nabob_framework::nabob_governance.</td>
