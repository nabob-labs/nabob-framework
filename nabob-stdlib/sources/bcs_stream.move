...
/// - Exception: For the `deserialize_address` function, the function-based approach from `nabob_std::from_bcs` is used
...
module nabob_std::bcs_stream {
    ...
    /// This function utilizes the `to_address` function from the `nabob_std::from_bcs` module,
