...
/// a general conversion back-and-force is needed, consider the `nabob_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
...
module nabob_std::from_bcs {
    ...
    friend nabob_std::any;
    friend nabob_std::copyable_any;
