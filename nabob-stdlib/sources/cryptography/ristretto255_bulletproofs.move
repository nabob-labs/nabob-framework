...
module nabob_std::ristretto255_bulletproofs {
    use std::error;
    use std::features;
    use std::vector;
    use nabob_std::ristretto255_pedersen as pedersen;
    use nabob_std::ristretto255::{Self, RistrettoPoint};
    ...
    #[test_only]
    use nabob_std::ristretto255::{Scalar, scalar_to_bytes};
    #[test_only]
    use nabob_std::ristretto255_pedersen::commitment_equals;

    #[test_only]
    const A_DST: vector<u8> = b"NabobBulletproofs";
    #[test_only]
