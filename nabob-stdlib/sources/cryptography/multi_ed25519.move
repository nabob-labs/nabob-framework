...
module nabob_std::multi_ed25519 {
    use std::bcs;
    use std::error;
    use std::features;
    ...
    /// The identifier of the MultiEd25519 signature scheme, which is used when deriving Nabob authentication keys by hashing
    ...
    /// Derives the Nabob-specific authentication key of the given Ed25519 public key.
