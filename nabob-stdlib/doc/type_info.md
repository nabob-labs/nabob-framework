...
<pre><code><b>public</b> <b>fun</b> <a href="type_info.md#0x1_type_info_chain_id">chain_id</a>(): u8 {
    <b>if</b> (!<a href="../../move-stdlib/doc/features.md#0x1_features_nabob_stdlib_chain_id_enabled">features::nabob_stdlib_chain_id_enabled</a>()) {
...
<pre><code><b>fun</b> <a href="type_info.md#0x1_type_info_verify_type_of">verify_type_of</a>() {
    ...
    <b>spec</b> {
        <b>assert</b> account_address == @nabob_std;
...
<pre><code><b>aborts_if</b> !<a href="../../move-stdlib/doc/features.md#0x1_features_spec_is_enabled">features::spec_is_enabled</a>(<a href="../../move-stdlib/doc/features.md#0x1_features_NABOB_STD_CHAIN_ID_NATIVES">features::NABOB_STD_CHAIN_ID_NATIVES</a>);
